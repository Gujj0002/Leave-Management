...
namespace Leave_Managment.Controllers
{
    ...
    public class LeaveRequestController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var leaveRequstsModel = _mapper.Map<List<LeaveRequestModel>>(leaveRequests);
        ...
        public ActionResult MyLeave()
        {
            ...
            var employeeAllocationsModel = _mapper.Map<List<LeaveAllocationModel>>(employeeAllocations);
            var employeeRequestsModel = _mapper.Map<List<LeaveRequestModel>>(employeeRequests);
        ...
        public ActionResult Details(int id)
        {
            ...
            var model = _mapper.Map<LeaveRequestModel>(leaveRequest);
            return View(model);
        }
